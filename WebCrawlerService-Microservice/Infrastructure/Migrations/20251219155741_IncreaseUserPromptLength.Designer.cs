...
namespace WebCrawlerService.Infrastructure.Migrations
{
    ...
    [Migration("20251219155741_IncreaseUserPromptLength")]
    partial class IncreaseUserPromptLength
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebCrawlerService.Domain.Entities.CrawlTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 12, 19, 15, 57, 40, 965, DateTimeKind.Utc).AddTicks(4626),
                            ...
                            IsValidated = true,
                            LastTestedAt = new DateTime(2025, 12, 19, 15, 57, 40, 965, DateTimeKind.Utc).AddTicks(4618),
                            ...
                            Type = 1,
                            UpdatedAt = new DateTime(2025, 12, 19, 15, 57, 40, 965, DateTimeKind.Utc).AddTicks(4626),
                            UsageCount = 0,
                            Version = 1
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 12, 19, 15, 57, 40, 965, DateTimeKind.Utc).AddTicks(4845),
                            ...
                            IsSystemTemplate = true,
                            IsValidated = true,
                            LastTestedAt = new DateTime(2025, 12, 19, 15, 57, 40, 965, DateTimeKind.Utc).AddTicks(4842),
                            MobileApiConfigJson = "{\"Provider\":0,\"BaseUrl\":\"https://shopee.vn\",\"ApiVersion\":\"v4\",\"RequiredHeaders\":{\"User-Agent\":\"Shopee/2.98.21 Android/11\",\"X-API-Source\":\"pc\",\"X-Shopee-Language\":\"vi\",\"Accept\":\"application/json\"},\"DefaultParams\":{},\"SignatureAlgorithm\":null,\"RequiresSignature\":false,\"RequiresCookies\":false,\"Region\":\"VN\",\"RateLimitPerMinute\":20,\"RequiresProxy\":false}",
                            MobileApiProvider = 0,
                            ...
                            Type = 1,
                            UpdatedAt = new DateTime(2025, 12, 19, 15, 57, 40, 965, DateTimeKind.Utc).AddTicks(4846),
                            UsageCount = 0,
                            Version = 1
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 12, 19, 15, 57, 40, 965, DateTimeKind.Utc).AddTicks(5215),
                            ...
                            IsSystemTemplate = true,
                            IsValidated = true,
                            LastTestedAt = new DateTime(2025, 12, 19, 15, 57, 40, 965, DateTimeKind.Utc).AddTicks(5212),
                            MobileApiConfigJson = "{\"Provider\":0,\"BaseUrl\":\"https://shopee.vn\",\"ApiVersion\":\"v4\",\"RequiredHeaders\":{\"User-Agent\":\"Shopee/2.98.21 Android/11\",\"X-API-Source\":\"pc\",\"X-Shopee-Language\":\"vi\",\"Accept\":\"application/json\"},\"DefaultParams\":{},\"SignatureAlgorithm\":null,\"RequiresSignature\":false,\"RequiresCookies\":false,\"Region\":\"VN\",\"RateLimitPerMinute\":20,\"RequiresProxy\":false}",
                            MobileApiProvider = 0,
                            ...
                            Type = 1,
                            UpdatedAt = new DateTime(2025, 12, 19, 15, 57, 40, 965, DateTimeKind.Utc).AddTicks(5215),
                            UsageCount = 0,
                            Version = 1
                        });
                });
