...
namespace WebCrawlerService.Infrastructure.Migrations
{
    ...
    [Migration("20251107125844_AddCollaborativeFields")]
    partial class AddCollaborativeFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebCrawlerService.Domain.Entities.CrawlTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 7, 12, 58, 43, 574, DateTimeKind.Utc).AddTicks(9532),
                            ...
                            IsValidated = true,
                            LastTestedAt = new DateTime(2025, 11, 7, 12, 58, 43, 574, DateTimeKind.Utc).AddTicks(9523),
                            ...
                            Type = 1,
                            UpdatedAt = new DateTime(2025, 11, 7, 12, 58, 43, 574, DateTimeKind.Utc).AddTicks(9533),
                            UsageCount = 0,
                            Version = 1
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 7, 12, 58, 43, 574, DateTimeKind.Utc).AddTicks(9796),
                            ...
                            IsSystemTemplate = true,
                            IsValidated = true,
                            LastTestedAt = new DateTime(2025, 11, 7, 12, 58, 43, 574, DateTimeKind.Utc).AddTicks(9793),
                            MobileApiConfigJson = "{\"Provider\":0,\"BaseUrl\":\"https://shopee.vn\",\"ApiVersion\":\"v4\",\"RequiredHeaders\":{\"User-Agent\":\"Shopee/2.98.21 Android/11\",\"X-API-Source\":\"pc\",\"X-Shopee-Language\":\"vi\",\"Accept\":\"application/json\"},\"DefaultParams\":{},\"SignatureAlgorithm\":null,\"RequiresSignature\":false,\"RequiresCookies\":false,\"Region\":\"VN\",\"RateLimitPerMinute\":20,\"RequiresProxy\":false}",
                            MobileApiProvider = 0,
                            ...
                            Type = 1,
                            UpdatedAt = new DateTime(2025, 11, 7, 12, 58, 43, 574, DateTimeKind.Utc).AddTicks(9796),
                            UsageCount = 0,
                            Version = 1
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 7, 12, 58, 43, 575, DateTimeKind.Utc).AddTicks(435),
                            ...
                            IsSystemTemplate = true,
                            IsValidated = true,
                            LastTestedAt = new DateTime(2025, 11, 7, 12, 58, 43, 575, DateTimeKind.Utc).AddTicks(432),
                            MobileApiConfigJson = "{\"Provider\":0,\"BaseUrl\":\"https://shopee.vn\",\"ApiVersion\":\"v4\",\"RequiredHeaders\":{\"User-Agent\":\"Shopee/2.98.21 Android/11\",\"X-API-Source\":\"pc\",\"X-Shopee-Language\":\"vi\",\"Accept\":\"application/json\"},\"DefaultParams\":{},\"SignatureAlgorithm\":null,\"RequiresSignature\":false,\"RequiresCookies\":false,\"Region\":\"VN\",\"RateLimitPerMinute\":20,\"RequiresProxy\":false}",
                            MobileApiProvider = 0,
                            ...
                            Type = 1,
                            UpdatedAt = new DateTime(2025, 11, 7, 12, 58, 43, 575, DateTimeKind.Utc).AddTicks(436),
                            UsageCount = 0,
                            Version = 1
                        });
                });
