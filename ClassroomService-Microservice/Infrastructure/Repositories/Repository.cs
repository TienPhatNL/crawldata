...
public class Repository<T> : IRepository<T> where T : BaseEntity
{
    ...
    public Repository(ClassroomDbContext context)
    {
        _context = context;
    ...
    /// <summary>
    /// Get entity by ID with navigation property includes
    /// </summary>
    ...
    /// <summary>
    /// Get entity by predicate with navigation property includes
    /// </summary>
    ...
    /// <summary>
    /// Get multiple entities with navigation property includes
    /// </summary>
